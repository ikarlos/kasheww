                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="text-center mx-auto" style="max-width: 700px;">
                            <h1 class="text-primary">Your Premium Source for Quality Dry Fruits, Spices, and Honey</h1>
                    ...
                    <div class="about-section bg-white p-4 rounded mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p>Founded in 2020, Kasheww has emerged as a leading provider of premium quality dry fruits, spices, and honey. Our journey began with a simple vision: to bring the finest natural products from around the world to our customers' tables. We believe in the power of nature's bounty and its ability to enhance both health and culinary experiences.</p>
                    ...
                    <div class="about-section bg-white p-4 rounded mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="feature-box text-center p-4">
                                    <i class="fas fa-honey fa-3x text-primary mb-3"></i>
                                    <h3 class="h5">Honey</h3>
                                    <p>Pure, natural honey from trusted beekeepers. We offer various types including raw honey, organic honey, and specialty varieties.</p>
                                </div>
                            </div>
                        </div>
                    </div>
